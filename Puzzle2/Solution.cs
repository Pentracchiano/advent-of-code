 class RockPaperScissors : PuzzleSolution {
  ...
  private enum Move
  {
    ...
    private (Move, Move) ParseLinePartOne(string line) {
      return (
        line switch{['A', ..] => Move.Rock, ['B', ..] => Move.Paper, ['C', ..] => Move.Scissors}, 
        line switch{[.., 'X'] => Move.Rock, [.., 'Y'] => Move.Paper, [.., 'Z'] => Move.Scissors}
      );
    }

    private (Move, Move) ParseLinePartTwo(string line) {
        Move theirs = line switch{['A', ..] => Move.Rock, ['B', ..] => Move.Paper, ['C', ..] => Move.Scissors};
    ...
    public string SolvePartOne(string? input) {
        return this.Solve(this.ParseLinePartOne);
    }

    public string SolvePartTwo(string? input) {
        return this.Solve(this.ParseLinePartTwo);
    }
 }   
